<div id="header-carousel" class="carousel slide" data-ride="carousel">
    <div class="carousel-inner">
        ...
        <div class="carousel-item carousel-item-height {{ ($key==0) ? 'active' : '' }}">
            <img class="img-fluid" src="{{ asset($img_val->defaultImg->product_img) }}" alt="{{ $img_val->url_product_name }}" />
            <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                <div class="p-3 max-width-700">
    ...
    <a class="carousel-control-prev" href="#header-carousel" data-slide="prev">
        <div class="btn btn-dark width-45px height-45px">

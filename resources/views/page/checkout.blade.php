        ...
        <div class="row px-xl-5">
                            ...
                            <div class="card border-secondary mb-5">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="d-flex justify-content-between">
                                        <p>{{$cart->product_list->product_name}}</p>
            ...
            <div class="col-lg-4">
                ...
                <div class="card border-secondary mt-5">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            <div class="custom-control custom-radio">
                                <input type="radio" class="custom-control-input" name="payment" id="gpay">
                    ...
                    <hr>
                    <div class="card-body">
                        <div class="form-group gpaydiv">
                            <div class="form-control">
                                <label class="forml-label" >GPay</label>
                                <input type="text" name="gpay_reference_no" id="gpay_reference_no" class='form-control' >
                            </div>
                        </div>
                        <div class="form-group paypaldiv" style="display:none;">
                            <div class="custom-control custom-radio">
                                <input type="radio" class="custom-control-input" name="payment" id="paypal">
                                <label class="custom-control-label" for="paypal">Paypal</label>
                            </div>
                        </div>
                        <div class="form-group banktransferdiv" style="display:none;">
                            <div class="custom-control custom-radio">
                                <input type="radio" class="custom-control-input" name="payment" id="directcheck">
                                <label class="custom-control-label" for="directcheck">Direct Check</label>
                            </div>
